...
Reads:
  xsw/octile_puzzle_data.py  — PUZZLE_DATA (11378 puzzles × 3 base-92 chars)
  xsw/difficulty_levels.json — levels[] (1-4), ordering{} (per-level base indices)
...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', 'xsw'))
...
diff_path = os.path.join(os.path.dirname(__file__), '..', '..', 'xsw', 'difficulty_levels.json')
