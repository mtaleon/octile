# Octile — Google Play Store Listing
...
> • Tap a tile to select it, then tap an empty cell to place it
...
puzzle, logic, tiles, brain teaser, math, Archimedes, board game, offline, no ads
